...
function Hozzaadas(seasons_number_input, kezdes_ornot, pass) {
        ...
        for(let i2 = 0; i2 < seasons_number_input; i2++) {
            out+= `
                    ...
                    <div id="season_hozzaadasnal${i2}" class="season_hozzaadasnal">
                        ...
                        <input type="number" name="epizodok_szama${i2}" class="beiroinput" id="epizodok_szama${i2}"><br>
